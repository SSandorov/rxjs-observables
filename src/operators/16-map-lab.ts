...
const calcularPorcentajeScroll = (event) => {
    //* Empleamos tres variables del evento scroll
    // clientHeight = altura de la pantalla del usuario
    // scrollHeight = la altura total de la sección del scroll
    // scrollTop = Posición más alta del scroll en la pantalla

    // Desestructuramos para acceder de manera más sencilla a las variables
    const {
        scrollTop,
        scrollHeight,
        clientHeight
